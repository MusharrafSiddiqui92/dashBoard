    ...
    return (
        <div className="container  mt-4 d-flex justify-content-end">
            <div className="row w-75 ">
                <div className="col">
                    <div className="card text-bg-primary mb-3" onClick={()=>navigate ('/products')} style={{ maxWidth: "18rem", height: "10rem",cursor:'pointer'}}>
                ...
                <div className="col">
                    <div className="card text-bg-success mb-3" onClick={()=>navigate('/Customers')} style={{ maxWidth: "18rem", height: "10rem",cursor:'pointer' }}>
                        {/* <div className="card-header">Header</div> */}
                        <div className="card-body">
